    ...
    <Resume>
      ...
      `}>
        <Container>
          <h2>Summary</h2>
          <div className="block">
            <p>Versatile Front End Engineer with 5+ years of experience designing, developing, maintaining, and sometimes breaking websites and web applications. Specializes in JavaScript(Vanilla, Reactjs, Gatsbyjs) and user experience design.</p>
          </div>
        </Container>
      </Section>
      <Section css={`
        ...
        <Container>
          ...
          <div className="block">
            ...
            `}>
              ...
              <li>Assisted developers with website enhancements within Wordpress sites. Specifically the <a href="https://dcdc.coe.hawaii.edu/ltec-112/">LTEC 112 website</a>.</li>
            </ul>
          </div>
          <hr></hr>
          <div className="block">
            ...
            <ul css={`
              list-style: circle;
            `}>
              <li>Designed <a href="https://coe.hawaii.edu/doctoral-student-rating-knowledge-skills-and-dispositions">infographics</a> involving stats for the College of Education.</li>
